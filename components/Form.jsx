  ...
  return (
    ...
    <section className="w-full max-w-full flex-start flex-col">
      <h1 className="head_text text-left">
        ...
        <p className="desc text-left max-w-md">{type} & Share amazing prompts...</p>
        <form 
        onSubmit={handleSubmit}
        className="mt-10 w-full max-w-2xl flex
        flex-col gap-7 glassmorphism border-none">
          <label>
          ...
          <div className="flex-end mx-3 mb-5 gap-4">
            ...
            type="submit"
            disabled={submiting}
            className="px-5 py-1.5 text-sm bg-red-600 rounded-full text-white"
            >
              {submiting? `${type}...`: type}
            </button>
          </div>
